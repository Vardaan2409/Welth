                    ...
                    <Container style={styles.container}>
                        ...
                        <Section style={styles.statsContainer}>
                            ...
                            <div style={styles.stat}>
                                ...
                                <Text style={styles.heading}>₹{(parseFloat(data?.budgetAmount) - parseFloat(data?.totalExpenses)).toFixed(1)}</Text>
                            </div>
                        </Section>
                    </Container>
                </Body>
                ...
                <Body style={styles.body}>
                    <Container style={styles.container}>
                        ...
                        <Section style={styles.statsContainer}>
                            <div style={styles.stat}>
                                <Text style={styles.text}>Budget Amount</Text>
                                <Text style={styles.heading}>₹{budgetAmount.toFixed(1)}</Text>
                            </div>
                            <div style={styles.stat}>
                                <Text style={styles.text}>Spent So Far</Text>
                                <Text style={styles.heading}>₹{totalExpenses.toFixed(1)}</Text>
                            </div>
                            <div style={styles.stat}>
                                <Text style={styles.text}>Remaining</Text>
                                <Text style={styles.heading}>₹{remaining.toFixed(1)}</Text>
                            </div>
                        </Section>
                    </Container>
                </Body>
